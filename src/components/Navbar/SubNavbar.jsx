...
const SubNavbar = () => {
  const [allPosts, setAllPosts] = useState(32);
  const [join, setJoin] = useState(false);

  return (
    <div
      className="d-none d-lg-flex justify-content-between mx-auto align-items-center sticky-top"
      style={{
        maxWidth: "1040px",
        height: "68px",
    ...
    >
      <ul class="nav my-2 nav-underline">
        <li class="nav-item">
          <a class="nav-link active dec" href="/">
            All Posts ({allPosts})
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link dec" href="/">
            Article
          </a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex my-2 align-items-center">
        ...
        >
          ...
          {join ? (
            <>
<button
          class="btn ms-2 gap-2 d-flex align-items-center "
        ...
        >
            ...
            <>
            <button
          class="btn btn-primary ms-2 gap-2 d-flex align-items-center "
          aria-label="Join group"
          onClick={() => {
            setJoin((prev) => !prev);
          }}
