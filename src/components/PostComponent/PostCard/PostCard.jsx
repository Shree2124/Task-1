...
const PostCard = ({ post }) => {
  ...
  return (
    ...
    >
      {post.image && <img className="imagePost" src={post.image} alt="" />}
      <div className="p-4">
        <h3>{post.title}</h3>
        <div className="d-flex gap-6 justify-content-between">
          ...
          <div className="btn align-self-start">
            <Dropdown id="dropdown-basic-button">
              <Dropdown.Toggle className="custom-dropdown-toggle bg-white">
                <img
        ...
        {(post.date || post.location) && (
          <>
            <ul className="mx-2 my-3 d-flex align-items-center gap-5 list-unstyled ">
            ...
            {post.type === "job" && (
              <button
                class="custom-post-link btn mb-4 fw-semibold"
        ...
        <p className="d-inline-block w-100">{post.content}</p>
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2">
            ...
            <div className="d-flex flex-column">
              <div className="text-wrapper">{post.user.name}</div>
